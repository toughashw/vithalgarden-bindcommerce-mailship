...
sudo systemctl enable api_push_mailship_orders.service
...
sudo systemctl start api_push_mailship_orders.service
...
sudo systemctl status api_push_mailship_orders.service
