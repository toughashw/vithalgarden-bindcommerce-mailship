...
function salva_csv() {
    ...
    $output_file_path = "/home/wsitalagro/webapps/ws-italagro/products/export_products_vg_$timestamp.csv";  // File CSV da salvare con il timestamp
    ...
    $columns_to_select = ['Internal SKU', 'Primary EAN', 'Name', 'Quantity'];
